...
library SomniaConfig {
    ...
    address public constant USDT_TOKEN =
        address(0x0ED782B8079529f7385c3eDA9fAf1EaA0DbC6a17); // PLACEHOLDER
    address public constant USDC_TOKEN =
        address(0x0ED782B8079529f7385c3eDA9fAf1EaA0DbC6a17); // PLACEHOLDER
    address public constant BTC_TOKEN =
        address(0xE3233Ee6E373Be04277a435facc262E7A9c46151); // PLACEHOLDER
    address public constant ARB_TOKEN = address(0); // UNASSIGNED PLACEHOLDER
    address public constant SOL_TOKEN =
        address(0xb35a7935F8fbc52fB525F16Af09329b3794E8C42); // PLACEHOLDER
